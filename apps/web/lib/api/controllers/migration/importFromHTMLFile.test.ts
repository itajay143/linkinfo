...
let prisma: typeof import("@linkinfo/prisma").prisma;
let importFromHTMLFile: typeof import("./importFromHTMLFile").default;
let removeFolder: typeof import("@linkinfo/filesystem").removeFolder;
...
beforeAll(async () => {
  ...
  const prismaModule = await import("@linkinfo/prisma");
  prisma = prismaModule.prisma;

  const filesystemModule = await import("@linkinfo/filesystem");
