...
import { Backup } from "@linkinfo/types/global";
import { createFolder } from "@linkinfo/filesystem";
import { hasPassedLimit } from "@linkinfo/lib/verifyCapacity";

export default async function importFromLinkinfo(
  userId: number,
  rawData: string
) {
