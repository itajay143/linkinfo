...
import { removeFolder, removeFile } from "@linkinfo/filesystem";
import { DeleteUserBody } from "@linkinfo/types/global";
import updateSeats from "@/lib/api/stripe/updateSeats";
import { meiliClient } from "@linkinfo/lib/meilisearchClient";
import stripeSDK from "@/lib/api/stripe/stripeSDK";
import transporter from "@linkinfo/lib/transporter";
        ...
        if (process.env.STRIPE_SECRET_KEY) {
          ...
          if (
            ...
            await transporter.sendMail({
              ...
              to: "hello@linkinfo.in",
              subject: "Linkinfo User Cancellation",
