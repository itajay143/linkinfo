...
export default function SettingsSidebar({ className }: { className?: string }) {
  ...
  const LINKINFO_VERSION = process.env.version;
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        <Link
          href={`https://github.com/linkinfo/linkinfo/releases`}
          target="_blank"
          className="text-neutral text-sm ml-2 hover:opacity-50 duration-100"
        >
          {t("linkinfo_version", { version: LINKINFO_VERSION })}
        </Link>
        <Link href="https://docs.linkinfo.in" target="_blank">
          <div
        ...
        <Link href="https://github.com/linkinfo/linkinfo" target="_blank">
          <div
            className={`hover:bg-neutral/20 duration-200 cursor-pointer flex items-center gap-2 rounded-lg px-3 py-1`}
          >
        ...
        <Link href="https://twitter.com/LinkinfoHQ" target="_blank">
          <div
            className={`hover:bg-neutral/20 duration-200 cursor-pointer flex items-center gap-2 rounded-lg px-3 py-1`}
          >
        ...
        <Link href="https://fosstodon.org/@linkinfo" target="_blank">
          <div
            className={`hover:bg-neutral/20 duration-200 cursor-pointer flex items-center gap-2 rounded-lg px-3 py-1`}
          >
