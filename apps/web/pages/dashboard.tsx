...
import { useUpdateUser, useUser } from "@linkinfo/router/user";
...
} from "@linkinfo/prisma/client";
import { DashboardLinks } from "@/components/DashboardLinks";
import { ViewMode } from "@linkinfo/types/global";
...
const Page: NextPageWithLayout = () => {
  ...
  useEffect(() => {
    if (
      ...
      // if user is using Linkinfo for more than 3 days
