...
import { usePublicLinks } from "@linkinfo/router/publicLinks";
import Links from "@/components/LinkViews/Links";
import { usePublicTags } from "@linkinfo/router/publicTags";
  ...
  if (!collection) return <></>;
    ...
    return (
      <div
        className="h-96"
        style={{
          backgroundImage: `linear-gradient(${collection?.color}30 10%, #f3f4f6 13rem, #ffffff 100%)`,
        }}
      >
        {collection && (
          <Head>
            <title>{collection.name} | Linkinfo</title>
            <meta
              property="og:title"
              content={`${collection.name} | Linkinfo`}
              key="title"
            />
          </Head>
        )}
          ...
          <div className="flex justify-between gap-2">
            ...
            <div className="flex flex-col gap-2 items-center mt-10 min-w-fit">
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger>
                    <Link href="https://linkinfo.in/" target="_blank">
                      <Image
                        src={`/icon.png`}
                        width={551}
                        height={551}
                  ...
                  <TooltipContent side="left">
                    <p>{t("list_created_with_linkinfo")}</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
        ...
        List created with <span className="text-black">Linkinfo.</span>
        </p> */}
          </div>
        </div>
