...
import importFromLinkinfo from "@/lib/api/controllers/migration/importFromLinkinfo";
import { MigrationFormat, MigrationRequest } from "@linkinfo/types/global";
...
export default async function users(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (req.method === "GET") {
    ...
    else if (request.format === MigrationFormat.linkinfo)
      data = await importFromLinkinfo(user.id, request.data);
