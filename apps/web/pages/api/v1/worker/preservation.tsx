...
import { DeletePreservationsSchema } from "@linkinfo/lib/schemaValidation";
import { removeFiles } from "@linkinfo/filesystem";
import { ArchivalSettings } from "@linkinfo/types/global";
import { isArchivalTag } from "@linkinfo/lib/isArchivalTag";
  ...
  if (req.method === "DELETE") {
    if (process.env.NEXT_PUBLIC_DEMO === "true")
      return res.status(400).json({
        response:
          "This action is disabled because this is a read-only demo of Linkinfo.",
      });

    const dataValidation = DeletePreservationsSchema.safeParse(req.body);
