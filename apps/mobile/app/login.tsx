...
export default function HomeScreen() {
  ...
  const [form, setForm] = useState({
    ...
    password: "",
    token: "",
    instance: auth.instance || "https://cloud.linkinfo.in",
  });

  const [showInstanceField, setShowInstanceField] = useState(
    form.instance !== "https://cloud.linkinfo.in"
  );
  ...
  useEffect(() => {
    setShowInstanceField(form.instance !== "https://cloud.linkinfo.in");
  }, [form.instance]);
      ...
      <KeyboardStickyView className="flex-col justify-end h-full bg-base-100 relative">
        <View className="flex-col justify-end h-full bg-primary relative">
          <View className="my-auto">
            <Image
              source={require("@/assets/images/linkinfo.png")}
            ...
            <TouchableOpacity
              onPress={() => {
                if (showInstanceField) {
                  setForm({
                    ...form,
                    instance: "https://cloud.linkinfo.in",
                  });
                }
